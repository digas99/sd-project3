...
xterm -T "AssaultPartyB" -hold -e "sshpass -f password ssh $ASSAULTPARTYBHOST './run_server.sh AssaultParty 22330 localhost 22331 /lib/genclass.jar'" &
xterm -T "CollectionSite" -hold -e "sshpass -f password ssh $COLLECTIONSITEHOST './run_server.sh CollectionSite 22330 localhost 22331 /lib/genclass.jar'" &
xterm -T "ConcentrationSite" -hold -e "sshpass -f password ssh $CONCENTRATIONSITEHOST './run_server.sh ConcentrationSite 22330 localhost 22331 /lib/genclass.jar'" &
xterm -T "Museum" -hold -e "sshpass -f password ssh $MUSEUMHOST './run_server.sh Museum 22330 localhost 22331 /lib/genclass.jar'" &
