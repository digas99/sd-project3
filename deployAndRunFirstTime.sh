...
sshpass -f password scp killPorts.sh sd304@l040101-ws09.ua.pt:/home/sd304/
sshpass -f password ssh sd304@l040101-ws09.ua.pt 'chmod +x killPorts.sh'
sshpass -f password ssh sd304@l040101-ws09.ua.pt './killPorts.sh'
