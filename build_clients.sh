...
cp $SRCFILES/client/main/Client$1Main.class temp/dir$1/client/main
cp $SRCFILES/client/entities/$1.class $SRCFILES/client/entities/$1States.class temp/dir$1/client/entities
