...
cp $SRCFILES/server/entities/$1ClientProxy.class temp/dir$1/server/entities
cp $SRCFILES/server/sharedRegions/$1Interface.class $SRCFILES/server/sharedRegions/$1.class temp/dir$1/server/sharedRegions
